...
#define UDATA_TOP_BIT    (((U_64)1)<<(sizeof(U_64)*8-1))
...
J9ZipCache *zipCache_new(J9PortLibrary * portLib, char *zipName, IDATA zipNameLength, I_64 zipFileSize, I_64 zipTimeStamp)
{
...
*/
void zipCache_setStartCentralDir(J9ZipCache * zipCache, U_64 startCentralDir)
{
 ...
 */
BOOLEAN zipCache_isSameZipFile(J9ZipCache * zipCache, IDATA zipTimeStamp, I_64 zipFileSize, const char *zipFileName, IDATA zipFileNameLength) {
	J9ZipCacheInternal *zci = (J9ZipCacheInternal *)zipCache;
	J9ZipCacheEntry *zce = zci->entry;
 ...
 * @return the startCentralDir of the cache
 */
U_64 zipCache_getStartCentralDir(J9ZipCache *zipCache) {
	J9ZipCacheInternal *zci = (J9ZipCacheInternal *)zipCache;
	J9ZipCacheEntry *zce = zci->entry;
...
J9ZipFileEntry *zipCache_addToFileList(J9PortLibrary *portLib, J9ZipCacheEntry *zce, J9ZipDirEntry * dirEntry, const char *namePtr, IDATA nameSize,
									 BOOLEAN isClass, U_64 elementOffset)
{
